...
export default function TicTacToeBoard({ board, onCellClick }) {
	return (
		<div className="grid grid-cols-3 gap-2 w-full max-w-xl aspect-square bg-slate-700 p-2 rounded-lg">
			{board.map((player, index) => {
				...
				return (
					<button
						...
						className="bg-slate-800 rounded-lg flex items-center justify-center text-6xl md:text-8xl font-bold text-white hover:bg-slate-600 disabled:hover:bg-slate-800"
