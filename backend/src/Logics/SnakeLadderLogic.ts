...
const defaultLadders: [number, number][] = [
	[4, 25],
	[13, 46],
	[42, 63],
	[50, 69],
...
const defaultSnakes: [number, number][] = [
	[27, 5],
	[40, 3],
	[43, 18],
	[54, 31],
...
export class SnakeLadderLogic implements IGameLogic {
	private cells: ("P1" | "P2")[][]; // Each cell is an array of players
	private size: number;
	...
	makeMove(move: any, player: "P1" | "P2"): MoveResult {
		...
		let winner: "P1" | "P2" | undefined = undefined;
